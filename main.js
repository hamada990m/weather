...
const API_KEY = "c4a353f83f284d14b41160755252506";
...
const weatherCodes = {
    ...
    snow: [1066, 1069, 1072, 1114, 1117, 1204, 1207, 1210, 1213, 1216, 1219, 1222, 1225, 1237, 1249,
...
const getWeatherDetails = async (API_URL) => {
    ...
    try{
        ...
        currentWeatherDiv.querySelector(".temperature").innerHTML = `${temperature}°C`;        
